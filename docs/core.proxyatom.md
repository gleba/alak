...
|  [isAsync](./core.proxyatom.isasync.md) | <code>Boolean</code> | Является ли уставленный добытчик [ProxyAtom.setGetter()](./core.proxyatom.setgetter.md) асинхронным |
|  [isAwaiting](./core.proxyatom.isawaiting.md) | <code>Boolean</code> | Находится ли атом в процессе получения значения от асинхронного добытчика [ProxyAtom.setGetter()](./core.proxyatom.setgetter.md) |
...
|  [isStateless](./core.proxyatom.isstateless.md) | <code>Boolean</code> | Находится ли атом в процессе получения значения от асинхронного добытчика [ProxyAtom.setGetter()](./core.proxyatom.setgetter.md) |
...
|  [onAwait(listener)](./core.proxyatom.onawait.md) | Добавить слушатель изменения асинхронного состояния функции добычи значения [ProxyAtom.setGetter()](./core.proxyatom.setgetter.md) |
...
|  [setGetter(getter, isAsync)](./core.proxyatom.setgetter.md) | Использовать функцию-добытчик значения контейнера |
|  [setId(id)](./core.proxyatom.setid.md) | Установить идентификатор |
|  [setName(name)](./core.proxyatom.setname.md) | Установить имя |
|  [setOnceGet(getter, isAsync)](./core.proxyatom.setonceget.md) | Использовать функцию-добытчик только один раз |
|  [setStateless(bool)](./core.proxyatom.setstateless.md) |  |
|  [setWrapper(wrapper, isAsync)](./core.proxyatom.setwrapper.md) | Использовать функцию-обёртку Каждое новое обновление значение контейнера атома, всегда будет проходить сперва через функцию-обёртку |
